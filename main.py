...
''' 
    ...
    File test.csv has information of all people you want to check attendence
'''
global data_student
data_student = pd.read_csv("test.csv")
                    ...
                    if frame_count % frame_skip_rate == 0:  # Process this frame
                      ...
                      if self.process_current_frame:
                        ...
                        for face_encoding in self.face_encodings:
                            ...
                            dob = 'Unknown'
                            if id != '######':   
                                name = getInformation(id)[0]
                                dob = getInformation(id)[1]
